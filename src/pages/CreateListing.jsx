  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (formData.imageUrls.length < 1)
        return setError("Atleast 1 image of property must be uploaded");

      if (+formData.regularPrice < +formData.discountPrice)
        return setError("Discounted price must be smaller that regular price");
      setLoading(true);
      setError(false);
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col flex-1 gap-4">
            ...
            formData.imageUrls.map((image, i) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-red-700 p-3 rounded-lg uppercase hover:bg-red-700 hover:text-white duration-500"
                >
                  Delete
                </button>
              </div>
          ...
          <button
            ...
            className="p-3 rounded-lg bg-slate-700 text-white hover:opacity-95 disabled:opacity-80"
          >
